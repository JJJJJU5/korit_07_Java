...
2~3문제 정도 구글에서 검색하는 것 가능.
Github, 자체 코드 정리한 노트 전부 확인 가능

ctrl + shift + f 누르면 파일 전체에서 검색이 가능함.

- 특정 문제가 md 파일에 없는걸 확신하면 구글에서 확인해서 알아봐야 할 때가 있음
...
제출만 하면 수정이 안됨
60점 미만은 재시험 대상자
1과목 / 2과목 둘 다 60점 이상 1과목이 60점 이하라면 1과목만 재시험
