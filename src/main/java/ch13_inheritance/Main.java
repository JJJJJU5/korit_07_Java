...
//        System.out.print("이 호랑이의 이름은 " + tigerName);
//        System.out.print(tigerAge + "살");
...
//        animal1.move();         // 부모 method 원본 그대로 호출
        ...
        human1.move();
        human1.setAnimalName("오정욱");
        human1.setAnimalAge(27);
        System.out.println("안녕하세요 제 이름은 " + human1.getAnimalName()+ " 제 나이는 " + human1.getAnimalAge() + "이고");
