...
/*
    ...
    생성자의 정의 방식.
      ...
      (사실 클래스를 만들 때 default로 생성되는 형태로 정의하지 않아도 될 때가 있음)
        ...
        ClassAMain, Carmain에서 객체를 생성했음 -> 복습
...
public class Constructor {
   //필드 선언
    ...
    // RequiredArgsConstructor(String 매개변수를 필수로 요구하는 생성자) 라는 안내문을 출력할수 있도록
    // 작성한 뒤
    // ConstructorMain으로 가서, constructor3이라는 객체명을 지니고 , title에 "내이름"으로
    // 지어 객체를 생성한 후
    // System.out.println(constructor3.name); 을 입력하여 콘솔에 내 이름을 출력
