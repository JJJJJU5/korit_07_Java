...
/*
    ...
    김이 학생의 점수를 등록하세요 >>> 4.5
    3 번 학생의 이름을 등록하세요 >>> 김삼
    김삼 학생의 점수를 등록하세요 >>> 4.5
    4 번 학생의 이름을 등록하세요 >>> 김사
    김사 학생의 점수를 등록하세요 >>> 4.5
    5 번 학생의 이름을 등록하세요 >>> 김오
    김오 학생의 점수를 등록하세요 >>> 4.5
...
public class Array03 {
    public static void main(String[] args) {
        ...
        for (int i=0; i < index ; i++) {
            ...
            System.out.print(names[i] + " 학생 점수 입력 >>> ");
            scores[i] = scanner.nextDouble();
            scanner.nextLine(); // 바로 위에 nextDouble 다음에 i++ 이후 nextLine()배치될 예정 베리어 위치
            sum += scores[i];
