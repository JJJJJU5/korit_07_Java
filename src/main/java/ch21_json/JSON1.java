...
public class JSON1 {
    public static void main(String[] args) {
        ...
        System.out.println();/*
            Map과의 차이가 있다면
            1. Map에서는 key에 ""가 없었고,
                JSON에서는 모든 key에 String 자료형 처럼 보이도록 ""가 있음
            2. Map에서는 key1=value1의 형태로 작성되어 있었지만
                JSON에서는 "key1":value1의 형태로 작성되어 있음.
         */
        jsonObject1.addProperty("job","코리아아이티국비강사");
        System.out.println(jsonObject1);
        System.out.println();
        /*
            가독성을 개선하는 방법으로 출력하는 방법은 컴퓨터가 읽기 편한 방식이 아니라 사람이 읽기 편한 방식으로 출력하는 것
            pretty printing 이라는 표현을 사용함
            이걸 외부에서 지원하는 방식
         */
