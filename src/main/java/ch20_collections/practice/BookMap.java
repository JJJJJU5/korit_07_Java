...
/*
    ...
    1. Map을 사용하여 도서명(String)을 key로 , 재고를 Integer로 하여 value
        ...
        while (!endOfProgram) {
            ...
            if (option == 1) {
                ...
                if(bookInvetory.containsKey(bookTitle)) {
                    ...
                    int bookStock = scanner.nextInt();
                    bookInvetory.put(bookTitle, bookStock);
                    System.out.println(bookTitle + " 도서 가 " + bookStock + "권으로 변경되었습니다");
                } else {
