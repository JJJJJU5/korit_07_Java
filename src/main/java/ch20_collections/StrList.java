...
public class StrList {
    public static void main(String[] args) {
        ...
        // List 출력방식            - toString() overriding이 되어있음
        ...
        /*
            이상의 코드에서 List는 element가 명확하게 일치하는지를 확인
            그래서 py가 python이라는 String 데이터의 일부이기는 하지만 element 전체를 의미하지는 않기
            때문에 false라는 결과값이 도출됨
        ...
        // List의 정렬
        Collections.sort(strList);   // 배열 정렬할 때랑 같음. 원본 List의 결과값을 바꿈
        System.out.println(strList);
