...
public class conversion {
    public static void main(String[] args) {
        ...
        // 업캐스팅 방법 # 1
        // 형 변환을 하기 위해서는 '(바꿀데이터타입) 변수명' 으로 작성 하시면 됩니다.
        System.out.println("변형 : " + (int)cast1);    //A를 int로 형 변환시 65(시험에나옴)

        char cast2 = 'a';
        System.out.println("원형 :" + cast2);
        System.out.println("변형 : " +(int)cast2); // 소문자 a의 경우 97

        //업캐스팅 방법 # 2
        // 새로운 변수를 선언하여 캐스팅이 이루어진 데이터를 잡아넣는 방법입니다.
        char cast3 = 'b';
        int casted3 = cast3; // 여기서는 (int)가 쓰여지지 않음
        // 대신 위를 보면 변수를 선언 할 때의 자료형이 변환되기를 원하는 자료형으로 명시해줍니다.
        System.out.println("원형 :" + cast3);
        System.out.println("원형 :" +casted3);
        ...
        /*
        37번 코드 라인에 오류가 발생하는 것은 정상입니다.
        추후 수업에서 더 중요하게 작용되는 개념인데, upcasting의 경우에는 메모리 용량이 커지면
        ...
        나오게 되겠죠)
        용량 오버에 해당하는 현상을 미리 점검하기 위해 다운 캐스팅시에는
        명시적(explicit)으로만 변형이 가능합니다.
        -> 현재는 기본 자료형을 기준으로 예시를 들었지만 나중에는 참조자료형 캐스팅 개념과
        연결됩니다. 아마도 14번 챕터였던 걸로 기억합니다. (소문자) 기본 자료형
         */
        //다운캐스팅 방법 # 2
